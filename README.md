...
2. Buka `index.html` menggunakan browser (Chrome / Firefox / Edge)
3. Navigasi antar halaman menggunakan menu di bagian atas

---

## Validasi

Seluruh halaman telah divalidasi menggunakan [W3C Markup Validation Service](https://validator.w3.org) dan tidak ditemukan error.

---

&copy; 2026 Air Biru. Dibuat untuk tugas mata kuliah Pemrograman Web. kuliah Pemrograman Web.
